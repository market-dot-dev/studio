...
const TierFeaturePickerWidget: React.FC<TierFeaturePickerWidgetProps> = ({
  tierId,
  newTier,
  selectedFeatureIds,
    ...
    <div className="w-full">
      {featuresLoading && (
        <div className="space-y-2">
          {[...Array(3)].map((_, i) => (
            <div key={i} className="flex h-5 items-center space-x-3">
