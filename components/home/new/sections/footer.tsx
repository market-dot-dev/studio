    ...
    <footer className="relative mx-auto w-full overflow-hidden px-6 pt-16 pb-36 lg:px-12 lg:pb-48 bg-gradient-to-t from-marketing-camo/[25%]">
      <div className="container relative mx-auto">
        <div className="flex w-full flex-col items-center">
          ...
          <p className="mb-6 max-w-[45ch] text-pretty text-center md:mb-8 md:text-[clamp(19px,12vw,24px)] md:leading-[clamp(20px,12vw,28px)] md:tracking-tight">
            Get started for free, no credit card required.
          </p>
          <Link href={loginURL} className="md:py-2 md:mx-6">
            <Button>
              <Image
                src="/github.svg"
                alt="github logo"
