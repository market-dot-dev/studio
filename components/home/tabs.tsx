      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12">
              ...
              <p className="text-4xl text-gray-400" data-aos="fade-up" data-aos-delay="200">All the tools you need to build a business from an open source project.</p>
            </div>
          ...
          <div>
            ...
            <div className="flex flex-wrap justify-center -m-2" data-aos="fade-up" data-aos-delay="400" data-aos-anchor="[data-aos-id-tabs]">
              ...
              >
                ...
                <span className="text-gray-100 group-hover:text-gray-200 transition-colors duration-150 ease-in-out">Build Premium Offerings</span>
              </button>
              <button
              ...
              >
                ...
                <span className="text-gray-100 group-hover:text-gray-200 transition-colors duration-150 ease-in-out">Promote Across Channels</span>
              </button>
              <button
              ...
              >
                ...
                <span className="text-gray-100 group-hover:text-gray-200 transition-colors duration-150 ease-in-out">Find Customers</span>
              </button>
            </div>
              ...
              <div className="relative flex flex-col mt-16" data-aos="fade-up" ref={tabs}>
                ...
                >
                  ...
                  <img src="/leads.png" alt="Leads" className="w-full rounded-2xl border-4 border-slate-400" />
                    ...
                    <div className="relative py-8 md:py-16 px-10 md:pr-16 md:max-w-lg lg:max-w-xl rounded-xl">
                    <h4 className="h4 mb-2 text-xl font-bold">Tools to Find and Grow Customers</h4>
                        <ul className="text-xl text-gray-400 mb-4">
                        ...
                        <Link href={maintainerLoginUrl}><Button color="green">Find Your First Customers →</Button></Link>        
                    </div>
                  </article>
                </Transition>
              </div>
