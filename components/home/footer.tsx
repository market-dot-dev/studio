      ...
      <div className="py-8 md:py-12 lg:py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            ...
            {/* Social links */}
            <ul className="flex justify-center mb-6 md:mb-0 gap-4 md:order-2">
              <li>
                <Link href="https://discord.gg/ZdSpS4BuGd" className="flex justify-center items-center text-gray-100 bg-gray-800 hover:text-gray-100 hover:bg-gray-700 rounded-full transition duration-150 ease-in-out w-10 h-10" aria-label="Discord">
                  <FaDiscord />
                </Link>
              </li>
