...
export default function Testimonial({ quote, quotee }: TestimonialProps) {
  return (
    <div className="mx-auto md:border-l md:pl-12 border-black/[15%] lg:border-none lg:pl-0 my-9 flex flex-col gap-4 text-pretty md:my-24 md:max-w-[100ch] lg:items-center md:gap-6 lg:text-center ">
