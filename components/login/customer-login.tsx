...
export function CustomerLoginComponent({
  ...
  return (
    <>
      {error ? (
        <div className="text-md flex w-full justify-center">
      ...
      {currentUser ? (
        ...
        <div>
          {isSignUp ? (
            <>
              <div className="mb-4">
                <div className="mb-4">
                  Please provide your details to create a Gitwallet account.
                </div>
          ...
          <p
            className="text-md mt-4 cursor-pointer text-center text-slate-500 underline"
        ...
        <div>
          <label className="text-md mb-4 block text-center text-slate-500">
