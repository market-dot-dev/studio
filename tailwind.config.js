  ...
  theme: {
  	extend: {
  		...
  		boxShadow: {
  			...
  			'border-sm': '0 0 0 1px rgba(0, 0, 0, 0.15), 0 1px 2px 0 rgb(0 0 0 / 0.05)',
  			'border': '0 0 0 1px rgba(0, 0, 0, 0.15), 0 1px 3px 0 rgb(0 0 0 / 0.1), 0 1px 2px -1px rgb(0 0 0 / 0.15)',
  			'border-md': '0 0 0 1px rgba(0, 0, 0, 0.15), 0 4px 6px -1px rgb(0 0 0 / 0.1), 0 2px 4px -2px rgb(0 0 0 / 0.1)',
  			'border-lg': '0 0 0 1px rgba(0, 0, 0, 0.15), 0 10px 15px -3px rgb(0 0 0 / 0.1), 0 4px 6px -4px rgb(0 0 0 / 0.1)',
  			'border-xl': '0 0 0 1px rgba(0, 0, 0, 0.15), 0 20px 25px -5px rgb(0 0 0 / 0.1), 0 8px 10px -6px rgb(0 0 0 / 0.1)',
