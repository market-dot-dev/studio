export default {
  name: 'Hero',
  template: `
    <section className="z-0 hero relative mx-auto flex flex-col items-center px-6 pb-16 md:px-12 md:pb-24 pt-64 w-full">
      <div
      ...
      <img
        src="/gw-logo-nav.png"
        alt="logo"
        className="mb-7 h-16 w-16 drop-shadow ring-black/10 md:mb-8 md:h-24 md:w-24"
      />
      <h1 className="font-gray-900 mb-5 text-center text-4xl font-medium tracking-tight sm:text-5xl md:mb-6 md:text-6xl">
        <SiteName></SiteName>
      </h1>
      <p className="mb-8 text-pretty text-center text-gray-500">
