      ...
      <div class="mx-auto flex max-w-5xl flex-col items-center gap-9 md:gap-12">
        <div class="flex max-w-xl flex-col gap-4 text-pretty">
          ...
          <p class="text-pretty text-center text-gray-500">
            We’re all about building smart, impactful software that makes a real difference. With a team of seasoned developers and problem-solvers, we’re here to help you get things done.
          </p>
        </div>
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3 lg:gap-x-9">
          <div class="flex flex-col items-start text-left rounded-lg bg-white p-6 shadow ring-1 ring-black/5 md:p-7">
            ...
            <p class="max-w-prose text-pretty text-sm text-gray-500">
              From sleek frontends to powerful backends, we handle it all. Our team builds digital products that look great and work even better.
            </p>
          </div>
          <div class="flex flex-col items-start text-left rounded-lg bg-white p-6 shadow ring-1 ring-black/5 md:p-7">
            ...
            <p class="max-w-prose text-pretty text-sm text-gray-500">
              We dig deep to find any security gaps and keep your data safe. With us, you get peace of mind that your systems are secure and reliable.
          ...
          <div class="flex flex-col items-start text-left rounded-lg bg-white p-6 shadow ring-1 ring-black/5 md:p-7">
            ...
            <p class="max-w-prose text-pretty text-sm text-gray-500">
              We fine-tune your applications to keep them fast and responsive. Whatever the load, we’ll make sure your tech can handle it without a hitch.
            </p>
          </div>
        </div>
      </div>
