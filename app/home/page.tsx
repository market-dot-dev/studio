          ...
          <section>
            <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
              ...
              <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
                ...
                <h1 className="mb-4 text-4xl font-bold leading-none tracking-tight md:text-5xl xl:text-5xl text-white"><CurvedUnderline>Commerce & analytics</CurvedUnderline><br/>for open source projects.</h1>
