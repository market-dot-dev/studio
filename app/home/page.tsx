...
export default function HomePage() {
  return (
    <div className="flex flex-col md:flex-row min-h-screen">
      ...
      {/* Left Column */}
      <div className="fixed top-0 left-0 w-full sm:w-1/2 h-full bg-slate-800 text-white flex flex-col justify-center p-8 md:p-32" style={{ backgroundImage: "url(/voronoi.png)" }}>
        <div className="overflow-y-auto">
          <div>
            <img src="/logo-white.png" width="170px" className="mb-6"/>
            <h1 className="text-3xl font-light leading-8 mb-6">Gitwallet is a business toolkit<br/>made for open source maintainers.</h1>
            <p className="text-xl mb-6">Gitwallet helps open source maintainers build, sell and manage robust support offerings for their repos and ecosystems.</p>
            <div className="flex gap-2 p-1 border-solid border-2 rounded-xl">
              <SimpleEmailInputForm placeholder="Enter Your Email" className="w-1/2" />
      ...
      {/* Right Column */}
      <div className="w-full sm:w-1/2 ml-auto bg-white overflow-y-auto p-16">
