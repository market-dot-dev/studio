...
{/* Left Column */}
<div className="md:fixed top-0 left-0 w-full md:w-4/12 h-full bg-slate-800 text-slate-50 flex flex-col justify-center p-8 lg:py-32 xl:px-32" style={{ backgroundImage: "url(/voronoi.png)" }}>
  <div className="">
    <div className="w-7/8">
...
{/* Right Column */}
<div className="w-full md:w-8/12 ml-auto bg-slate-100 text-slate-800 overflow-y-auto p-8 md:p-16">
  <section className="mb-2 w-7/8 lg:w-5/6">
    <Badge className="mb-4" size="md"><Bold>Now Available</Bold></Badge>
  </section>


  <section className="mb-12 w-7/8 lg:w-5/6">
    <div className="flex flex-row gap-8">
      <div className="w-2/5">
        <h3 className="text-2xl font-bold leading-none tracking-tight mb-2">Quickly setup commercial services & paid products.</h3>
        <p className="mb-4">Easily setup robust paid support channels, premium services, paid downloads and dual license distributions for your open source.</p>
  ...
  <section className="mb-12 w-7/8 lg:w-5/6">
    <div className="flex flex-row gap-8">
      ...
      <div className="w-2/5">
        <h3 className="text-2xl font-bold leading-none tracking-tight mb-2">Get new & actionable insights about your project usage.</h3>
        <p className="mb-4">
  ...
  <section className="mb-12 w-7/8 lg:w-5/6">
    <div className="flex flex-row gap-8">
      <div className="w-2/5">
        <h3 className="text-2xl font-bold leading-none tracking-tight mb-2">Find your buyers & sell across channels.</h3>
        <p className="mb-4">
          Gitwallet gives you the tools to help you setup and automate outbound & inbound sales channels.
        </p>
        {/* <Button size="xs" variant="secondary">Learn More →</Button> */}
      </div>
      <div className="w-3/5">
  ...
  <section className="mb-8 w-7/8 lg:w-5/6">
    <div className="flex flex-row gap-4">
      <div className="w-3/5">
        <h3 className="text-2xl font-bold leading-none tracking-tight mb-2">Manage an open source business.</h3>
        <p className="mb-4">
          From contracts to customer management, Gitwallet helps you manage your business.
        </p>
        <Button size="xs" variant="secondary">Learn More →</Button>
      </div>
      <div className="w-2/5">
