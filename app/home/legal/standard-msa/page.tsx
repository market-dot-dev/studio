  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen">
      ...
      <div className="md:fixed top-0 left-0 w-full md:w-2/5 h-full bg-slate-800 text-slate-50 flex flex-col justify-center p-8 lg:py-32 xl:px-32" style={{ backgroundImage: "url(/voronoi.png)" }}>
        ...
        <p className="text-sm text-stone-500">Market.dev has created a Master Service Agreement optimized for the world of Open Source. This is an agreement between a maintainer and their customers and covers the services being offered to customers.</p>
      </div>
