...
import { OfferingPageStates } from "@/components/internal-use/PageStates";
...
export default async function ProjectPage() {
  const [pageState, setPageState] = useState(OfferingPageStates.ServiceOfferingSelected);
    ...
    <div className="flex max-w-screen-xl flex-col space-y-12 p-8">
      <div className="flex flex-col space-y-6">
        ...
        <Grid numItems={5} className="gap-2 mb-4">
          ...
          {(pageState === OfferingPageStates.SupportOptionsHidden) &&
            <>
              ...
              <Col numColSpan={4}>
                <div className="flex flex-col bg-gray-50 h-full pt-24 text-center h-full rounded-xl">
                  Please select a support category to view fulfillment options.
                </div>
              </Col>
            </>
          }

          {(pageState === OfferingPageStates.AllSupportOptionsShown) &&
            <>
              {/* COLUMN 1: SERVICE OFFERING CATEGORIES */}
              <Col numColSpan={1}>
                <div className="text-lg font-bold mb-2">Support Categories</div>
          ...
          {(pageState === OfferingPageStates.ServiceOfferingSelected) &&
            <>
              {/* COLUMN 1: SERVICE OFFERING CATEGORIES */}
              <Col numColSpan={1}>
                <div className="text-lg font-bold mb-2">Support Categories</div>
