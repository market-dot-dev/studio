...
export default function TiersEmptyState() {
	...
	const [multipleTemplates, setMultipleTemplates] = useState(false);

	
	return (
		<TiersTemplates open={templatesOpen} setOpen={setTemplatesOpen} multiple={multipleTemplates}>
