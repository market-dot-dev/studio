...
export default function TierForm({ tier }: { tier: TierWithFeatures }) {
  ...
  const [applicationFeePrice, setApplicationFeePrice] = useState(
    ...
    <form onSubmit={handleSubmit}>
      ...
      <div className="mb-4">
        ...
        <NumberInput
          ...
          enableStepper={false}
          error={
            !!tier.applicationFeePercent && tier.applicationFeePercent >= 100
          }
