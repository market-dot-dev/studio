...
export function TeamMemberEditRoleBtn({ member }: Props) {
  ...
  // Can't edit pending invites or owner role directly
              ...
              >
                <div className="flex w-full items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <span className="text-left text-sm font-semibold text-stone-800">Member</span>
                  </div>
                  <input
                    id="role-member"
                    type="radio"
