...
import DependentPackages, {
  RepoItem,
} from "@/components/packages/dependent-packages";
  ...
  return (
    <TabGroup defaultIndex={tabIndex} onIndexChange={setTabIndex}>
      ...
      >
        <Tab
          className={
            "py-1 text-stone-600 " + (tabIndex === 0 ? "bg-stone-100" : "")
          }
        >
          Revenue
        </Tab>
        <Tab
          className={
            "py-1 text-stone-600 " + (tabIndex === 1 ? "bg-stone-100" : "")
          }
        >
          Repos
        </Tab>
