...
export default function HomePageLayout({ children }: { children: React.ReactNode }) {
  return (
    ...
    >
      ...
      <main className="flex w-full flex-col gap-24 lg:gap-y-32 overflow-visible xl:col-span-8 2xl:col-span-8 2xl:col-start-5 max-w-[800px] lg:max-w-[1300px] mx-auto px-6 pt-12 md:p-12 lg:pt-24 xl:pt-32">
        {children}
      </main>
    </div>
  );
